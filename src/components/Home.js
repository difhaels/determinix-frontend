import bg1 from "./img/bg/bg1.jpeg";
import bg2 from "./img/bg/bg2.jpeg";
import bg3 from "./img/bg/bg3.jpeg";
      ...
      <div className="bg-[#131313] hidden sm:block">
        ...
        >
          <SwiperSlide>
            ...
            <img src={bg1} height="100vh" alt="home1" />
          </SwiperSlide>
          <SwiperSlide>
            <div className="absolute left-0 right-0 top-52 3xl:top-72 text-center">
            ...
            <img src={bg2} height="100vh" alt="home2" />
          </SwiperSlide>
          <SwiperSlide>
            <div className="absolute left-0 right-0 top-52 3xl:top-72 text-center">
            ...
            <img src={bg3} height="100vh" alt="home3" />
          </SwiperSlide>
        </Swiper>
      </div>
    </div>
